 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */(function(e){function t(P,R){var O=P.length;P.push(R);e:for(;0<O;){var H=O-1>>>1,Y=P[H];if(0<o(Y,R))P[H]=R,P[O]=Y,O=H;else break e}}function n(P){return P.length===0?null:P[0]}function r(P){if(P.length===0)return null;var R=P[0],O=P.pop();if(O!==R){P[0]=O;e:for(var H=0,Y=P.length,an=Y>>>1;H<an;){var rt=2*(H+1)-1,jt=P[rt],Le=rt+1,kt=P[Le];if(0>o(jt,O))Le<Y&&0>o(kt,jt)?(P[H]=kt,P[Le]=O,H=Le):(P[H]=jt,P[rt]=O,H=rt);else if(Le<Y&&0>o(kt,O))P[H]=kt,P[Le]=O,H=Le;else break e}}return R}function o(P,R){var O=P.sortIndex-R.sortIndex;return O!==0?O:P.id-R.id}if(typeof performance=="object"&&typeof performance.now=="function"){var i=performance;e.unstable_now=function(){return i.now()}}else{var l=Date,s=l.now();e.unstable_now=function(){return l.now()-s}}var u=[],a=[],f=1,m=null,h=3,g=!1,y=!1,v=!1,C=typeof setTimeout=="function"?setTimeout:null,p=typeof clearTimeout=="function"?clearTimeout:null,c=typeof setImmediate<"u"?setImmediate:null;typeof navigator<"u"&&navigator.scheduling!==void 0&&navigator.scheduling.isInputPending!==void 0&&navigator.scheduling.isInputPending.bind(navigator.scheduling);function d(P){for(var R=n(a);R!==null;){if(R.callback===null)r(a);else if(R.startTime<=P)r(a),R.sortIndex=R.expirationTime,t(u,R);else break;R=n(a)}}function w(P){if(v=!1,d(P),!y)if(n(u)!==null)y=!0,Sr(x);else{var R=n(a);R!==null&&un(w,R.startTime-P)}}function x(P,R){y=!1,v&&(v=!1,p($),$=-1),g=!0;var O=h;try{for(d(R),m=n(u);m!==null&&(!(m.expirationTime>R)||P&&!Ee());){var H=m.callback;if(typeof H=="function"){m.callback=null,h=m.priorityLevel;var Y=H(m.expirationTime<=R);R=e.unstable_now(),typeof Y=="function"?m.callback=Y:m===n(u)&&r(u),d(R)}else r(u);m=n(u)}if(m!==null)var an=!0;else{var rt=n(a);rt!==null&&un(w,rt.startTime-R),an=!1}return an}finally{m=null,h=O,g=!1}}var k=!1,S=null,$=-1,B=5,M=-1;function Ee(){return!(e.unstable_now()-M<B)}function ln(){if(S!==null){var P=e.unstable_now();M=P;var R=!0;try{R=S(!0,P)}finally{R?sn():(k=!1,S=null)}}else k=!1}var sn;if(typeof c=="function")sn=function(){c(ln)};else if(typeof MessageChannel<"u"){var $o=new MessageChannel,Kl=$o.port2;$o.port1.onmessage=ln,sn=function(){Kl.postMessage(null)}}else sn=function(){C(ln,0)};function Sr(P){S=P,k||(k=!0,sn())}function un(P,R){$=C(function(){P(e.unstable_now())},R)}e.unstable_IdlePriority=5,e.unstable_ImmediatePriority=1,e.unstable_LowPriority=4,e.unstable_NormalPriority=3,e.unstable_Profiling=null,e.unstable_UserBlockingPriority=2,e.unstable_cancelCallback=function(P){P.callback=null},e.unstable_continueExecution=function(){y||g||(y=!0,Sr(x))},e.unstable_forceFrameRate=function(P){0>P||125<P?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):B=0<P?Math.floor(1e3/P):5},e.unstable_getCurrentPriorityLevel=function(){return h},e.unstable_getFirstCallbackNode=function(){return n(u)},e.unstable_next=function(P){switch(h){case 1:case 2:case 3:var R=3;break;default:R=h}var O=h;h=R;try{return P()}finally{h=O}},e.unstable_pauseExecution=function(){},e.unstable_requestPaint=function(){},e.unstable_runWithPriority=function(P,R){switch(P){case 1:case 2:case 3:case 4:case 5:break;default:P=3}var O=h;h=P;try{return R()}finally{h=O}},e.unstable_scheduleCallback=function(P,R,O){var H=e.unstable_now();switch(typeof O=="object"&&O!==null?(O=O.delay,O=typeof O=="number"&&0<O?H+O:H):O=H,P){case 1:var Y=-1;break;case 2:Y=250;break;case 5:Y=1073741823;break;case 4:Y=1e4;break;default:Y=5e3}return Y=O+Y,P={id:f++,callback:R,priorityLevel:P,startTime:O,expirationTime:Y,sortIndex:-1},O>H?(P.sortIndex=O,t(a,P),n(u)===null&&P===n(a)&&(v?(p($),$=-1):v=!0,un(w,O-H))):(P.sortIndex=Y,t(u,P),y||g||(y=!0,Sr(x))),P},e.unstable_shouldYield=Ee,e.unstable_wrapCallback=function(P){var R=h;return function(){var O=h;h=R;try{return P.apply(this,arguments)}finally{h=O}}}})(ad);ud.exports=ad;var Km=ud.exports;/**
 * @license React
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var Co=I;function fv(e,t){return e===t&&(e!==0||1/e===1/t)||e!==e&&t!==t}var dv=typeof Object.is=="function"?Object.is:fv,pv=Co.useSyncExternalStore,mv=Co.useRef,hv=Co.useEffect,yv=Co.useMemo,gv=Co.useDebugValue;G0.useSyncExternalStoreWithSelector=function(e,t,n,r,o){var i=mv(null);if(i.current===null){var l={hasValue:!1,value:null};i.current=l}else l=i.current;i=yv(function(){function u(g){if(!a){if(a=!0,f=g,g=r(g),o!==void 0&&l.hasValue){var y=l.value;if(o(y,g))return m=y}return m=g}if(y=m,dv(f,g))return y;var v=r(g);return o!==void 0&&o(y,v)?y:(f=g,m=v)}var a=!1,f,m,h=n===void 0?null:n;return[function(){return u(t())},h===null?void 0:function(){return u(h())}]},[t,n,r,o]);var s=pv(e,i[0],i[1]);return hv(function(){l.hasValue=!0,l.value=s},[s]),gv(s),s};K0.exports=G0;var vv=K0.exports,Be="default"in vi?En:vi,Df=Symbol.for("react-redux-context"),Ff=typeof globalThis<"u"?globalThis:{};function wv(){if(!Be.createContext)return{};const e=Ff[Df]??(Ff[Df]=new Map);let t=e.get(Be.createContext);return t||(t=Be.createContext(null),e.set(Be.createContext,t)),t}var bi=wv(),Sv=()=>{throw new Error("uSES not initialized!")};function Z0(e=bi){return function(){return Be.useContext(e)}}var xv=Z0(),b0=Sv,kv=e=>{b0=e},Ev=(e,t)=>e===t;function Cv(e=bi){const t=e===bi?xv:Z0(e),n=(r,o={})=>{const{equalityFn:i=Ev,devModeChecks:l={}}=typeof o=="function"?{equalityFn:o}:o,{store:s,subscription:u,getServerState:a,stabilityCheck:f,identityFunctionCheck:m}=t();Be.useRef(!0);const h=Be.useCallback({[r.name](y){return r(y)}}[r.name],[r,f,l.stabilityCheck]),g=b0(u.addNestedSub,s.getState,a||s.getState,h,i);return Be.useDebugValue(g),g};return Object.assign(n,{withTypes:()=>n}),n}var _v=Cv();function $v(e){e()}function Pv(){let e=null,t=null;return{clear(){e=null,t=null},notify(){$v(()=>{let n=e;for(;n;)n.callback(),n=n.next})},get(){const n=[];let r=e;for(;r;)n.push(r),r=r.next;return n},subscribe(n){let r=!0;const o=t={callback:n,next:null,prev:t};return o.prev?o.prev.next=o:e=o,function(){!r||e===null||(r=!1,o.next?o.next.prev=o.prev:t=o.prev,o.prev?o.prev.next=o.next:e=o.next)}}}}var Bf={notify(){},get:()=>[]};function Nv(e,t){let n,r=Bf,o=0,i=!1;function l(v){f();const C=r.subscribe(v);let p=!1;return()=>{p||(p=!0,C(),m())}}function s(){r.notify()}function u(){y.onStateChange&&y.onStateChange()}function a(){return i}function f(){o++,n||(n=e.subscribe(u),r=Pv())}function m(){o--,n&&o===0&&(n(),n=void 0,r.clear(),r=Bf)}function h(){i||(i=!0,f())}function g(){i&&(i=!1,m())}const y={addNestedSub:l,notifyNestedSubs:s,handleChangeWrapper:u,isSubscribed:a,trySubscribe:h,tryUnsubscribe:g,getListeners:()=>r};return y}var Tv=typeof window<"u"&&typeof window.document<"u"&&typeof window.document.createElement<"u",Rv=typeof navigator<"u"&&navigator.product==="ReactNative",Ov=Tv||Rv?Be.useLayoutEffect:Be.useEffect;function zv({store:e,context:t,children:n,serverState:r,stabilityCheck:o="once",identityFunctionCheck:i="once"}){const l=Be.useMemo(()=>{const a=Nv(e);return{store:e,subscription:a,getServerState:r?()=>r:void 0,stabilityCheck:o,identityFunctionCheck:i}},[e,r,o,i]),s=Be.useMemo(()=>e.getState(),[e]);Ov(()=>{const{subscription:a}=l;return a.onStateChange=a.notifyNestedSubs,a.trySubscribe(),s!==e.getState()&&a.notifyNestedSubs(),()=>{a.tryUnsubscribe(),a.onStateChange=void 0}},[l,s]);const u=t||bi;return Be.createElement(u.Provider,{value:l},n)}var Iv=zv;kv(vv.useSyncExternalStoreWithSelector);const Mv=()=>{const[e,t]=I.useState(!1),n=_v(av);return T.jsxs(jv,{children:[T.jsx("a",{className:"logo",children:T.jsx("img",{src:"images/images/logo.svg",alt:""})}),T.jsxs(Lv,{children:[T.jsx("a",{href:"#",children:"Vehicles"}),T.jsx("a",{href:"#",children:"Energy"}),T.jsx("a",{href:"#",children:"Charging"}),T.jsx("a",{href:"#",children:"Discover"}),T.jsx("a",{href:"#",children:"Shop"})]}),T.jsxs(Av,{children:[T.jsx("a",{href:"#",children:"Shop"}),T.jsx("a",{href:"#",children:"Account"})," ",T.jsx(Dv,{onClick:()=>t(!0)})]}),T.jsxs(Fv,{show:e,children:[T.jsx(Uv,{children:T.jsx(Bv,{onClick:()=>t(!1)})}),n&&n.map(r=>T.jsx("li",{children:T.jsx("a",{href:"#",children:r},r)})),T.jsx("li",{children:T.jsx("a",{href:"#",children:"Help me choose"})}),T.jsx("li",{children:T.jsx("a",{href:"#",children:"Trade-In"})}),T.jsx("li",{children:T.jsx("a",{href:"#",children:"Cybertruck"})}),T.jsx("li",{children:T.jsx("a",{href:"#",children:"Roadster"})}),T.jsx("li",{children:T.jsx("a",{href:"#",children:"Charging"})}),T.jsx("li",{children:T.jsx("a",{href:"#",children:"Accessories"})}),T.jsx("li",{children:T.jsx("a",{href:"#",children:"Semis"})})]})]})},jv=ke.div`
  min-height: 60px;
  position: fixed;
  display: flex;
  align-items: center;
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var tc=Symbol.for("react.element"),nc=Symbol.for("react.portal"),Dl=Symbol.for("react.fragment"),Fl=Symbol.for("react.strict_mode"),Bl=Symbol.for("react.profiler"),Ul=Symbol.for("react.provider"),Vl=Symbol.for("react.context"),Xw=Symbol.for("react.server_context"),Wl=Symbol.for("react.forward_ref"),Hl=Symbol.for("react.suspense"),Yl=Symbol.for("react.suspense_list"),Ql=Symbol.for("react.memo"),Xl=Symbol.for("react.lazy"),Kw=Symbol.for("react.offscreen"),Sm;Sm=Symbol.for("react.module.reference");function nt(e){if(typeof e=="object"&&e!==null){var t=e.$$typeof;switch(t){case tc:switch(e=e.type,e){case Dl:case Bl:case Fl:case Hl:case Yl:return e;default:switch(e=e&&e.$$typeof,e){case Xw:case Vl:case Wl:case Xl:case Ql:case Ul:return e;default:return t}}case nc:return t}}}W.ContextConsumer=Vl;W.ContextProvider=Ul;W.Element=tc;W.ForwardRef=Wl;W.Fragment=Dl;W.Lazy=Xl;W.Memo=Ql;W.Portal=nc;W.Profiler=Bl;W.StrictMode=Fl;W.Suspense=Hl;W.SuspenseList=Yl;W.isAsyncMode=function(){return!1};W.isConcurrentMode=function(){return!1};W.isContextConsumer=function(e){return nt(e)===Vl};W.isContextProvider=function(e){return nt(e)===Ul};W.isElement=function(e){return typeof e=="object"&&e!==null&&e.$$typeof===tc};W.isForwardRef=function(e){return nt(e)===Wl};W.isFragment=function(e){return nt(e)===Dl};W.isLazy=function(e){return nt(e)===Xl};W.isMemo=function(e){return nt(e)===Ql};W.isPortal=function(e){return nt(e)===nc};W.isProfiler=function(e){return nt(e)===Bl};W.isStrictMode=function(e){return nt(e)===Fl};W.isSuspense=function(e){return nt(e)===Hl};W.isSuspenseList=function(e){return nt(e)===Yl};W.isValidElementType=function(e){return typeof e=="string"||typeof e=="function"||e===Dl||e===Bl||e===Fl||e===Hl||e===Yl||e===Kw||typeof e=="object"&&e!==null&&(e.$$typeof===Xl||e.$$typeof===Ql||e.$$typeof===Ul||e.$$typeof===Vl||e.$$typeof===Wl||e.$$typeof===Sm||e.getModuleId!==void 0)};W.typeOf=nt;wm.exports=W;var Gw=wm.exports;_`
  from,
  20%,
  53%,
  to {
...
`;const fn=({title:e,backgroundImg:t,description:n,rightBtnText:r,leftBtnText:o})=>T.jsxs(PS,{bgimage:t,className:"section",children:[T.jsx(Gf,{children:T.jsxs(NS,{children:[T.jsx("p",{className:"title",children:e}),T.jsx("p",{children:n})]})}),T.jsx(zS,{children:T.jsxs(Gf,{children:[T.jsxs(TS,{children:[T.jsx(Cm,{children:o}),r&&T.jsx(RS,{children:r})]}),T.jsx(OS,{src:"images/images/down-arrow.svg"})]})})]}),PS=ke.div`
  width: 100vw;
  height: 100vh;
  background-size: cover;
  background-image: ${e=>`url("/images/images/${e.bgimage}")`};
...
`,zS=ke.div`
  text-align: center;
`,IS=()=>T.jsx("div",{children:T.jsxs(MS,{className:"sections",children:[T.jsx(fn,{title:"Model Y",description:"Sleek curves, bold presence",backgroundImg:"model-y.jpg",rightBtnText:"Existing Inventory",leftBtnText:"Custom Order"}),T.jsx(fn,{title:"Model 3",description:"Order Online for Touchless Delivery",backgroundImg:"mod-3.jpg",rightBtnText:"Existing Inventory",leftBtnText:"Custom Order"}),T.jsx(fn,{title:"Model X",description:"Tight Lines, Futuristic Design",backgroundImg:"model-x.jpg",rightBtnText:"Existing Inventory",leftBtnText:"Custom Order"}),T.jsx(fn,{title:"Model S",description:"Luxurious comfort, spacious interiors",backgroundImg:"modell-3.jpg",rightBtnText:"Existing Inventory",leftBtnText:"Custom Order"}),T.jsx(fn,{title:"Lowest Cost Solar Panels in America",description:"Money-back guarantee",backgroundImg:"solar-panel.jpg",leftBtnText:"Order now",rightBtnText:"Learn more"}),T.jsx(fn,{title:"Solar for new roofs",description:"Solar Roof Costs Less Than a New Roof Plus Solar Panels",backgroundImg:"solar-roof.jpg",leftBtnText:"Order now",rightBtnText:"Learn more"}),T.jsx(fn,{title:"Accessories",description:"",backgroundImg:"accessories.jpg",leftBtnText:"Shop now"})]})}),MS=ke.div`
  height: 100vh;
  overflow: scroll;
  scroll-snap-type: y mandatory;
`;function jS(){return T.jsxs("div",{className:"app",children:[T.jsx(Mv,{}),T.jsx(IS,{})]})}const LS=Ug({reducer:{car:cv}});u0(document.getElementById("root")).render(T.jsx(Iv,{store:LS,children:T.jsx(jS,{})}));
