...
`;const fn=({title:e,backgroundImg:t,description:n,rightBtnText:r,leftBtnText:o})=>{const i="https://res.cloudinary.com/dfztelw7e/image/upload/v1716719247/model-y_hb7nok.jpg";return console.log(i),R.jsxs(PS,{bgimage:i,className:"section",children:[R.jsx(Gf,{children:R.jsxs(NS,{children:[R.jsx("p",{className:"title",children:e}),R.jsx("p",{children:n})]})}),R.jsx(OS,{children:R.jsxs(Gf,{children:[R.jsxs(TS,{children:[R.jsx(Cm,{children:o}),r&&R.jsx(RS,{children:r})]}),R.jsx(zS,{src:"https://res.cloudinary.com/dfztelw7e/image/upload/v1716719243/favicon_kse9xd.ico"})]})})]})},PS=ke.div`
  width: 100vw;
  height: 100vh;
...
`,OS=ke.div`
  text-align: center;
`,IS=()=>R.jsx("div",{children:R.jsxs(MS,{className:"sections",children:[R.jsx(fn,{title:"Model Y",description:"Sleek curves, bold presence",backgroundImg:"https://res.cloudinary.com/dfztelw7e/image/upload/mod-3_nrqqum.jpg",rightBtnText:"Existing Inventory",leftBtnText:"Custom Order"}),R.jsx(fn,{title:"Model 3",description:"Order Online for Touchless Delivery",backgroundImg:"https://res.cloudinary.com/dfztelw7e/image/upload/v1716719247/model-y_hb7nok.jpg",rightBtnText:"Existing Inventory",leftBtnText:"Custom Order"}),R.jsx(fn,{title:"Model X",description:"Tight Lines, Futuristic Design",backgroundImg:"https://res.cloudinary.com/dfztelw7e/image/upload/v1716719247/model-y_hb7nok.jpg",rightBtnText:"Existing Inventory",leftBtnText:"Custom Order"}),R.jsx(fn,{title:"Model S",description:"Luxurious comfort, spacious interiors",backgroundImg:"https://res.cloudinary.com/dfztelw7e/image/upload/v1716719247/model-y_hb7nok.jpg",rightBtnText:"Existing Inventory",leftBtnText:"Custom Order"}),R.jsx(fn,{title:"Lowest Cost Solar Panels in America",description:"Money-back guarantee",backgroundImg:"https://res.cloudinary.com/dfztelw7e/image/upload/v1716719247/model-y_hb7nok.jpg",leftBtnText:"Order now",rightBtnText:"Learn more"}),R.jsx(fn,{title:"Solar for new roofs",description:"Solar Roof Costs Less Than a New Roof Plus Solar Panels",backgroundImg:"https://res.cloudinary.com/dfztelw7e/image/upload/v1716719247/model-y_hb7nok.jpg",leftBtnText:"Order now",rightBtnText:"Learn more"}),R.jsx(fn,{title:"Accessories",description:"",backgroundImg:"https://res.cloudinary.com/dfztelw7e/image/upload/v1716719247/model-y_hb7nok.jpg",leftBtnText:"Shop now"})]})}),MS=ke.div`
  height: 100vh;
  overflow: scroll;
